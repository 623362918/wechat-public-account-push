...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx0ddea3b7131ebd2a',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '78dd8540c3e6076b41ee604ad4579192',
   ...
   */
  USERS: [oN7AL6znmRmt97IuYXm75vLh4HA0,oN7AL63ypAdrH2yuS7x0riEtqFhc
    {
      // 想要发送的人的名字
      name: '姐姐',
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'cfdOyLGJBDE7PJ1l8ys60DrsotTlKpLmgB9-izfRolk',
      // 所在省份
      province: '四川',
      // 所在城市
      city: '南充',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '姐姐', year: '2001', date: '11-08',
        },
        {
          type: '*生日', name: '弟弟', year: '2002', date: '08-05',
        }
      ],
